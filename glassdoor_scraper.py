...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
    ...
    url = "https://www.glassdoor.com/Job/jobs.htm?suggestCount=0&suggestChosen=false&clickSource=searchBtn&typedKeyword=" + keyword + \
        "&sc.keyword=" + keyword + "&locT=C&locId=1148170&jobType="
    driver.get(url)
    jobs = []
    ...
    while len(jobs) < num_jobs:  # If true, should be still looking for new jobs.
        ...
        for job_button in job_buttons:
            ...
            try:
                ...
                try:
                    size = driver.find_element_by_class_name("css-13q36n").text
                except NoSuchElementException:
                    size = -1
